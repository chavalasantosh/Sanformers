"""
TokenBridge - Connect santok_complete tokenizer to cognitive graph.
...
class TokenBridge:
    """
    Bridge between santok_complete's tokenizer and santok_cognitive's graph.
    ...
    def add_tokens(
        ...
        Args:
            tokens: List of TokenRecord objects from santok_complete
    ...
    def add_token(self, token: Any) -> int:
        ...
        Args:
            token: TokenRecord from santok_complete
