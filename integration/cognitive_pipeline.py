...
Combines:
- Tokenization (santok_complete)
- Embedding generation (santok_complete)
- Knowledge graph (santok_cognitive)
- Inference (santok_cognitive)
- Hybrid reasoning (santok_cognitive)

This is the main integration point between santok_complete and santok_cognitive.
"""
...
class CognitivePipeline:
    ...
    Architecture:
        ...
        Tokenization (santok_complete)
          ↓
        Graph + Embeddings (santok_cognitive + santok_complete)
          ↓
    ...
    Example:
        ...
        # With santok_complete integration
    ...
    def set_tokenizer(self, tokenizer: Any) -> None:
        """
        Set the tokenizer from santok_complete.
    ...
    def set_embedding_generator(self, generator: Any) -> None:
        """
        Set the embedding generator from santok_complete.
