"""
VectorBridge - Connect santok_complete vector stores to cognitive memory.
...
class VectorBridge:
    """
    Bridge between santok_complete's vector stores and santok_cognitive.
    ...
    Example:
        from santok_complete.embeddings.vector_store import FAISSVectorStore
    ...
    def __init__(
        ...
        Args:
            ...
            vector_store: Vector store from santok_complete (optional)
